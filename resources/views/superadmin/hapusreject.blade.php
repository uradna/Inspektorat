<x-superadminwide-layout>
    ...
    <x-slot name="title">
        {{ __('Data Pegawai - Permintaan Hapus Yang Ditolak') }}
    </x-slot>
    ...
    <x-slot name="content">
        <div class="row">
            <div class="col-12">
                <div class="card ">
                    <div class=" card-body">
                        <h4 class="header-title mb-3">Permintaan Penghapusan Pegawai Ditolak</h4>
                            ...
                            <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                <thead class="bg-lighter">
                                    <tr>
                                        ...
                                        <th>Satker</th>
                                        <th data-priority="5">Perangkat Daerah</th>
                                        <th data-priority="4">Alasan</th>
                                        <th data-priority="3">Alasan Ditolak</th>
                                                ...
                                                <td class="text-center">
                                                    <form action="{{ route('superadmin.hapus.setuju') }}" method="POST"
                                                        ...
                                                        <button type="button" class="btn btn-info btn-xsm pbutton"
                                                            data-quantity="../../pdf/{{ $d->file }}|{{ $d->user->name }}"
