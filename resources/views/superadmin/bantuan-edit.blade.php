                    ...
                    <div class=" card-body">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate="" method="POST"
                                action="{{ route('superadmin.help.update') }}">
                                ...
                                <div class="row">
                                    <div class="position-relative mb-2 col-md-9">
                                        <div class="form-floating">
                                            <x-input-float :id="__('judul')" type="text" value="{{ $data->judul }}"
                                                required />
                                    ...
                                    <div class="position-relative mb-2 col-md-3 form-floating">
                                        <div class="form-floating">
                                            <select class="form-select" id="floatingSelect"
                                                ...
                                                <option @if ($data->for == 'user') selected @endif value="user">User Pegawai
                                                </option>
                                                <option @if ($data->for == 'admin') selected @endif value="admin">User Admin
                                                </option>
                                                <option @if ($data->for == 'superadmin') selected @endif value="superadmin">User
                                                    Superadmin</option>
                                            </select>
