<x-user-layout>
    ...
    <x-slot name="content">
        <div class="row">
                ...
                <div class="card ">
                    <div class=" card-body">
                        ...
                        <div class="alert alert-primary alert-dismissible bg-dark text-white border-0 fade show"
                            ...
                            Anda juga dapat melaporkan gratifikasi melalui situs <a href="https://gol.kpk.go.id/"
                                target="_blank" class="text-warning"><b>https://gol.kpk.go.id</b></a>
                        </div>
                                        ...
                                        @foreach ($lapor as $d)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($d->pernyataan_id == null)
                                                        <form action="{{ route('user.lapor.delete') }}" method="POST">
                                                            @csrf
                        ...
                        <div class="modal-body">
                            <form class="needs-validation @if ($errors->any()) was-validated @endif" novalidate="" method="POST"
                                ...
                                <div class="row ">
                                    ...
                                    <div class="position-relative mb-2 col-md-6">
                                        <div class="form-floating">
                                            <x-input-float :id="__('tanggal')" type="date" max="{{ date('Y-m-d') }}"
            ...
            {{-- <div id="alert1" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content rounded-3">
                        <div class="modal-body p-3">
                            <div class="text-center">
                                <i class="ri-check-line h1 font-36 text-success"></i>
                                <h4 class="mt-2 fw-light font-24">Berhasil..!</h4>
                                <p class="mt-3 font-16">Laporan disimpan</p>
                                <button type="button" class="btn btn-success my-2" data-bs-dismiss="modal">ok</button>
                            </div>
                        </div>
                    </div><!-- /.modal-content -->
                </div><!-- /.modal-dialog -->
