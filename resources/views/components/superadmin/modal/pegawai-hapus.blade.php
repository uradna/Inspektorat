        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="needs-validation" novalidate="" method="POST"
                    action="{{ route('superadmin.hapus.tolak') }}">
                    @csrf
                    <input type="hidden" class="d-id" name="id">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="position-relative mb-2 col-md-12">
                            <div class="form-floating">
                                <x-input-float :id="__('feedback')" type="text" class="bg-white" required />
                                <x-invalid :value="__('Masukkan alasan penghapusan user')" />
                                <x-label-float :value="__('Alasan ditolak')" />
                            </div>
                        </div>
                    </div>
